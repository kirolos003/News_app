...
class NewsListViewModel extends ChangeNotifier {
  ...
  getNews(String categoryTitle) async {
    // we make them equal to null just in case there was no internet connection and we
    // pressed try again and we called this function we have to clear the error message
    // or it will display the same error message
    showLoading = true;
    errorMessage = null;
    newsList = null;
    try {
